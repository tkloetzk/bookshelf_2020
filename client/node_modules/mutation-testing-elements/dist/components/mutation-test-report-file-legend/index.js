...
let MutationTestReportFileLegendComponent = class MutationTestReportFileLegendComponent extends LitElement {
    ...
    updateModel() {
        this.filters = ["Killed" /* Killed */, "Survived" /* Survived */, "NoCoverage" /* NoCoverage */, "Ignored" /* Ignored */, "Timeout" /* Timeout */, "CompileError" /* CompileError */, "RuntimeError" /* RuntimeError */]
